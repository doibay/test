 ...
 * 
 * Extend this "model" if you need to add additional types, most likely you want to extend the "generate" method
 */
class XfAddOns_Sitemap_Model_Sitemap extends XfAddOns_Sitemap_Helper_Base
{
	 ...
	 */
	protected function generateAdditionalUrls()
	{
		$options = XenForo_Application::getOptions();
		...
		$urls = new XfAddOns_Sitemap_Helper_AdditionalUrls();
		$urls->generate();
		if (!$urls->isEmpty)
		{
			$this->sitemaps[] = $urls->save($this->getSitemapName('urls'));
		}
	}

	/**
	 * Addons may override this method to generate additional sitemaps
	 */
